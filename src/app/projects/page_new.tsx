                ...
                >
                  ...
                  <div className="relative h-48 bg-[#F3F3F3] overflow-hidden">
                    {project.thumbnail_image ? (
                      ...
                      <div className="flex items-center justify-center h-full">
                        <div className="text-center">
                          <div className="w-12 h-12 bg-[#191A23] rounded-lg flex items-center justify-center mx-auto mb-2">
                            <Code2 className="w-6 h-6 text-[#B9FF66]" />
                          </div>
                    ...
                    {/* Batch Badge */}
                    {project.batch && (
                      <div className="absolute bottom-3 left-3 bg-white/90 text-[#191A23] px-2 py-1 text-xs font-medium rounded">
                        Batch {project.batch}
                      </div>
                    )}
                    ...
                    {/* Status Badge */}
                    {project.status && (
                      <div className={`absolute bottom-3 right-3 px-2 py-1 text-xs font-medium rounded ${
