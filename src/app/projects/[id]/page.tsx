                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="flex flex-wrap gap-2.5 justify-center lg:justify-start">
                    {project.team_members.map((member, index) => {
                      const TeamMemberCard = member.linkedin_url ? 'a' : 'div';
                      const cardProps = member.linkedin_url
                        ? {
                            href: member.linkedin_url,
                            target: '_blank',
                            rel: 'noopener noreferrer',
                            className: 'bg-white/80 border border-white/60 px-3 py-2.5 rounded-xl hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/40 transition-all duration-300 cursor-pointer transform hover:scale-105 hover:shadow-lg group'
                          }
                        : {
                      ...
                      return (
                        <TeamMemberCard
                          ...
                          {...cardProps}
                        >
                          <div className="font-medium text-sm md:text-base text-[#191A23] flex items-center gap-1.5">
                            {member.name}
                            {member.linkedin_url && (
                              <svg
                                className="w-4 h-4 text-[#0A66C2] opacity-0 group-hover:opacity-100 transition-opacity"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                              >
